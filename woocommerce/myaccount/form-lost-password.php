			...
			<div class="shop-content-grey-border">
				...
				<form method="post" class="lost_reset_password">
					...
					<?php if( 'lost_password' == $args['form'] ) : ?>
						...
						<p class="lost-password-description"><?php echo apply_filters( 'woocommerce_lost_password_message', __( 'Lost your password? Please enter your username or email address. You will receive a link to create a new password via email.', 'woocommerce' ) ); ?></p>
