...
<h2 class="my-account-your-orders"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Your Orders', 'woocommerce' ) ); ?></h2>
							...
							<td class="order-actions">
								<?php
									...
									if ( $order->needs_payment() ) {
										$actions['pay'] = array(
											'url'  => 'https://mspomelo.com/checkout',
